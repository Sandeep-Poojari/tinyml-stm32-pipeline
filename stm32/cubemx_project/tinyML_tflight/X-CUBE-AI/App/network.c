...
#define AI_NETWORK_MODEL_SIGNATURE     "0xbaaa6e8e3b96a52c52da7bc3d291236e"
...
#define AI_TOOLS_DATE_TIME   "2026-04-09T19:26:47+0200"
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_output_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.03373336046934128f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_0_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.008705073036253452f, 0.010410566814243793f, 0.009140277281403542f, 0.009277217090129852f, 0.009853251278400421f, 0.008493317291140556f, 0.00976853258907795f, 0.009113924577832222f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.3277449309825897f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(conv2d_2_weights_array_intq, AI_STATIC_CONST,
  ...
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.005283149890601635f, 0.008628809824585915f, 0.008631173521280289f, 0.010092990472912788f, 0.005643945652991533f, 0.006666506640613079f, 0.006830843165516853f, 0.00609269505366683f, 0.006155998911708593f, 0.007721537258476019f, 0.006064417771995068f, 0.006264493800699711f, 0.006969863548874855f, 0.006173080299049616f, 0.007126274053007364f, 0.004302786197513342f),
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_8_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(3.6989762783050537f),
    AI_PACK_INTQ_ZP(-128)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_8_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.007446786388754845f),
    AI_PACK_INTQ_ZP(0)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_9_output_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(3.794179677963257f),
    AI_PACK_INTQ_ZP(-35)))
...
AI_INTQ_INFO_LIST_OBJ_DECLARE(gemm_9_weights_array_intq, AI_STATIC_CONST,
  AI_BUFFER_META_FLAG_SCALE_FLOAT|AI_BUFFER_META_FLAG_ZEROPOINT_S8, 1,
  AI_PACK_INTQ_INFO(
    AI_PACK_INTQ_SCALE(0.004382785875350237f),
    AI_PACK_INTQ_ZP(0)))
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x1,
  AI_SHAPE_INIT(4, 1, 8, 13, 13), AI_STRIDE_INIT(4, 1, 1, 8, 104),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x1,
  AI_SHAPE_INIT(4, 1, 8, 26, 2), AI_STRIDE_INIT(4, 1, 1, 8, 208),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  9, 0x1,
  AI_SHAPE_INIT(4, 1, 16, 11, 2), AI_STRIDE_INIT(4, 1, 1, 16, 176),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  13, 0x0,
  AI_SHAPE_INIT(4, 1, 400, 1, 1), AI_STRIDE_INIT(4, 2, 2, 800, 800),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x1,
  AI_SHAPE_INIT(4, 400, 16, 1, 1), AI_STRIDE_INIT(4, 1, 400, 6400, 6400),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  18, 0x1,
  AI_SHAPE_INIT(4, 16, 10, 1, 1), AI_STRIDE_INIT(4, 1, 16, 160, 160),
...
AI_STATIC_CONST ai_i32 nl_10_nl_params_data[] = { 2036984704, 28, -7 };
AI_ARRAY_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    7984, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 4600, 1, 1),
    4600, NULL, NULL),
  ...
  &conv2d_0_layer, 0x57bd1d51, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_input_layer0_output_array.data = AI_PTR(g_network_activations_map[0] + 808);
    serving_default_input_layer0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 808);
    conv2d_0_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 1592);
    conv2d_0_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 1592);
    conv2d_0_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 1884);
    conv2d_0_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 1884);
    conv2d_0_output_array.data = AI_PTR(g_network_activations_map[0] + 80);
    conv2d_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 80);
    conv2d_2_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 1432);
    conv2d_2_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 1432);
    conv2d_2_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 4248);
    conv2d_2_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 4248);
    ...
    gemm_8_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 400);
    gemm_8_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 400);
    gemm_8_output_array.data = AI_PTR(g_network_activations_map[0] + 1200);
    gemm_8_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1200);
    ...
    nl_10_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 0);
    nl_10_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 0);
    nl_10_output_array.data = AI_PTR(g_network_activations_map[0] + 44);
    nl_10_output_array.data_start = AI_PTR(g_network_activations_map[0] + 44);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_8_bias_array.data = AI_PTR(g_network_weights_map[0] + 7720);
    gemm_8_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 7720);
    gemm_9_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_weights_array.data = AI_PTR(g_network_weights_map[0] + 7784);
    gemm_9_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 7784);
    gemm_9_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_9_bias_array.data = AI_PTR(g_network_weights_map[0] + 7944);
    gemm_9_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 7944);
    return true;
  }
