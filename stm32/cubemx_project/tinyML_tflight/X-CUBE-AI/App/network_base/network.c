...
#define AI_NETWORK_MODEL_SIGNATURE     "0xdca63658130aadd45a3171df85f6c301"
...
#define AI_TOOLS_DATE_TIME   "2026-04-09T18:57:22+0200"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  17, 0x0,
  AI_SHAPE_INIT(4, 400, 16, 1, 1), AI_STRIDE_INIT(4, 4, 1600, 25600, 25600),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 31336, 1, 1),
    31336, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &conv2d_conv2d_layer, 0xc408c175, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_0_output_array.data = AI_PTR(g_network_activations_map[0] + 3536);
    input_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 3536);
    conv2d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 6672);
    conv2d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 6672);
    conv2d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 6708);
    conv2d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 6708);
    conv2d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 320);
    conv2d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 320);
    conv2d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 5728);
    conv2d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 5728);
    conv2d_1_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 6016);
    conv2d_1_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 6016);
    ...
    dense_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 1600);
    dense_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1600);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 30592);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 30592);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 30656);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 30656);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 31296);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 31296);
    return true;
  }
